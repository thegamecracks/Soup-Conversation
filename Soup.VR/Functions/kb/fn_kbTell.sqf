/*
    Author: Karel Moricky, thegamecracks
...
if (count _listUnits > 0) then {
    ...
    [["conversationStart",[_volumeCoef, _disableRadio]],"TGC_fnc_kbTellLocal",(_listUnits + playableUnits + switchableUnits)] call bis_fnc_mp;
    ...
    for "_s" from _sentenceStartId to _sentenceEndId do {
        ...
        //--- Speak!
        [["sentence",[_from,_params],[_mission,_topicName]],"TGC_fnc_kbTellLocal"] call bis_fnc_mp;
...
*/
    ...
    [["conversationEnd",[_volumeCoef, _disableRadio]],"TGC_fnc_kbTellLocal",(_listUnits + playableUnits + switchableUnits)] call bis_fnc_mp;
